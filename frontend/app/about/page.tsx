...
const visionItems = [
  {
    icon: Eye,
    title: "Our Vision",
    description: "To create a world where every child receives early support and understanding, enabling them to thrive and reach their full potential regardless of neurodevelopmental differences.",
  },
  {
    icon: Target,
    title: "Our Mission",
    description: "We empower parents, guardians, and healthcare professionals with accessible tools and knowledge for early ASD awareness, bridging the gap between concern and professional guidance.",
  },
  {
    icon: Users,
    title: "Who We Serve",
    description: "Parents seeking answers, healthcare providers looking for screening resources, and educators wanting to better understand the children in their care.",
  },
];
...
const faqItems = [
  {
    ...
    answer: "ASD Risk Analysis is an awareness and screening tool designed to help identify potential signs of Autism Spectrum Disorder in children. It provides preliminary insights based on behavioral observations and developmental milestones, helping parents and caregivers decide when to seek professional evaluation.",
  },
  {
    question: "Is this tool a medical diagnosis?",
    answer: "No, this tool is NOT a medical diagnosis. It is designed for awareness and early screening purposes only. A formal ASD diagnosis can only be made by qualified healthcare professionals such as pediatricians, psychologists, or developmental specialists through comprehensive evaluation.",
  },
  {
    question: "Who should use this tool?",
    answer: "This tool is designed for parents, guardians, caregivers, and healthcare professionals who want to better understand a child's developmental patterns. It can be particularly helpful for those who have concerns about a child's social communication, behavior, or developmental milestones.",
  },
  {
    question: "What age range does this screening cover?",
    answer: "Our screening tool is designed for children between 18 months and 5 years of age, which is the critical window for early detection and intervention. However, we also provide resources for older children and adults.",
  },
  {
  ...
  },
  {
    ...
    answer: "If the screening indicates elevated risk, we recommend scheduling an appointment with your child's pediatrician or a developmental specialist. Early intervention services can make a significant positive impact on a child's development, so timely professional evaluation is important.",
  },
  {
    question: "Is my data kept private and secure?",
    answer: "Yes, we take data privacy very seriously. All personal information and assessment results are encrypted and stored securely. We do not share individual data with third parties. Please review our Privacy Policy for complete details.",
  },
];
        ...
        <section className="py-2 lg:py-12">
          <div className="container mx-auto px-2 lg:px-8 text-center">
            ...
            <p className="text-lg text-[#4b4b4b] max-w-2xl mx-auto">
              ...
              providing families with the resources they need to support their children.
            </p>
          </div>
        </section>
