...
const Index = () => {
  ...
  return (
    <main className="min-h-screen px-8 md:px-20 lg:px-[50px] pt-20">
      ...
      {/* Main Content */}
      <div className="max-w-6xl bg-[#d0e9fc] text-[#4b4b4b] bg-gradient-to-b from-white/40 via-white/20 to-white/40 rounded-xl shadow-md p-6 px-8 mx-auto sm:px-6 lg:px-8 py-10 md:py-14">        
