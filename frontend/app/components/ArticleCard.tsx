...
export function ArticleCard({ article, index }: ArticleCardProps) {
  return (
    <article
      className="bg-[#fff] bg-gradient-to-b from-white/40 via-white/20 to-white/40 shadow-sm hover:shadow-lg group rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 flex flex-col animate-fade-in"
